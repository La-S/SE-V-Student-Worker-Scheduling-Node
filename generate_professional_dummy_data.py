...
def create_position(businessUnitId, name, payRate, color="#FFA726"):
...
brian_employee_id_brew = create_employee(Brian['id'], the_brew['id'], 'SP26', True, 40, 0, False)
ben_employee_id_brew = create_employee(Ben['id'], the_brew['id'], 'SP26', True, 20, 0, False)
leia_employee_id_brew = create_employee(Leia['id'], the_brew['id'], 'SP26', True, 20, 0, False)
luke_employee_id_brew = create_employee(Luke['id'], the_brew['id'], 'SP26', True, 20, 0, False)
han_employee_id_brew = create_employee(Han['id'], the_brew['id'], 'SP26', True, 20, 0, False)
cody_employee_id_brew = create_employee(Cody['id'], the_brew['id'], 'SP26', True, 20, 0, False)
bar_back = create_position(the_brew['id'], "Bar Back", 10.00, "#42A5F5")
barista = create_position(the_brew['id'], "Barista", 12.00, "#EF5350")
cashier = create_position(the_brew['id'], "Cashier", 10.00, "#66BB6A")
...
brian_employee_id_dub = create_employee(Brian['id'], the_dub['id'], 'SP26', True, 40, 0, False)
ben_employee_id_dub = create_employee(Ben['id'], the_dub['id'], 'SP26', True, 20, 0, False)
leia_employee_id_dub = create_employee(Leia['id'], the_dub['id'], 'SP26', True, 20, 0, False)
luke_employee_id_dub = create_employee(Luke['id'], the_dub['id'], 'SP26', True, 20, 0, False)
han_employee_id_dub = create_employee(Han['id'], the_dub['id'], 'SP26', True, 20, 0, False)
cody_employee_id_dub = create_employee(Cody['id'], the_dub['id'], 'SP26', True, 20, 0, False)
lifeguard = create_position(the_dub['id'], "Lifeguard", 15.00, "#42A5F5")
front_desk = create_position(the_dub['id'], "Front Desk", 8.25, "#EF5350")
personal_trainer = create_position(the_dub['id'], "Personal Trainer", 25.00, "#66BB6A")
opening_tasks = create_tasklist(the_dub['id'], "Opening Tasks")
wipe_equipment = create_task(opening_tasks['id'], 'Wipe down equipment', 1)
start_music = create_task(opening_tasks['id'], 'Start Music', 2)
refill_wipes = create_task(opening_tasks['id'], 'Refill Wipes', 3)
closing_tasks = create_tasklist(the_dub['id'], "Closing Tasks")
kick_everyone = create_task(closing_tasks['id'], 'Tell everyone to leave', 1)
...
for employee in [brian_employee_id_dub, ben_employee_id_dub, leia_employee_id_dub, luke_employee_id_dub, han_employee_id_dub, cody_employee_id_dub]:
    ...
    give_employee_a_position(employee['id'], personal_trainer['id'])

give_employee_a_position(brian_employee_id_dub['id'], lifeguard['id'])


create_availability_template(ben_employee_id_dub['id'], "Thursday", "06:00", "10:00", "available")
create_availability_template(ben_employee_id_dub['id'], "Thursday", "12:00", "17:00", "preferred")
create_availability_template(ben_employee_id_dub['id'], "Thursday", "10:00", "12:00", "unavailable")

create_availability_template(brian_employee_id_dub['id'], "Thursday", "04:00", "08:00", "available")
create_availability_template(brian_employee_id_dub['id'], "Thursday", "08:00", "11:30", "unavailable")
create_availability_template(brian_employee_id_dub['id'], "Thursday", "14:00", "19:00", "available")

create_availability_template(leia_employee_id_dub['id'], "Thursday", "06:00", "20:00", "available")

create_availability_template(luke_employee_id_dub['id'], "Thursday", "10:00", "15:00", "preferred")
create_availability_template(luke_employee_id_dub['id'], "Thursday", "17:00", "19:00", "unavailable")

create_availability_template(han_employee_id_dub['id'], "Thursday", "8:00", "9:00", "unavailable")
create_availability_template(han_employee_id_dub['id'], "Thursday", "10:00", "11:00", "unavailable")
create_availability_template(han_employee_id_dub['id'], "Thursday", "12:00", "13:00", "unavailable")
create_availability_template(han_employee_id_dub['id'], "Thursday", "14:00", "15:00", "unavailable")
create_availability_template(han_employee_id_dub['id'], "Thursday", "15:00", "16:00", "unavailable")
...
# ben works a lot
give_employee_a_position(ben_employee_id_brew['id'], cashier['id'])

shift5 = create_shift(ben_employee_id_brew['id'], the_brew['id'], cashier['id'], "16:00", "18:00", TODAYS_DATE, True)
shift6 = create_shift(ben_employee_id_brew['id'], the_brew['id'], cashier['id'], "20:15", "21:10", TODAYS_DATE, True)
shift6 = create_shift(ben_employee_id_brew['id'], the_brew['id'], cashier['id'], "10:30", "15:10", TOMORROWS_DATE, True)
shift6 = create_shift(ben_employee_id_brew['id'], the_brew['id'], cashier['id'], "7:15", "9:10", YESTERDAYS_DATE, True)

# shift7 = create_shift(ben_employee_id_brew['id'], the_brew['id'], cashier['id'], "16:00", "19:00", TODAYS_DATE, True)

give_employee_a_position(leia_employee_id_brew['id'], barista['id'])
give_employee_a_position(cody_employee_id_brew['id'], bar_back['id'])
...
if (IS_PROD):
    ...
    give_employee_a_position(your_user['id'], front_desk['id'])
    give_employee_a_position(your_user['id'], personal_trainer['id'])
    ...
    gus_employee_dub = create_employee(your_user['id'], the_dub['id'], 'SP26', True, 40, 0, True) # you work at the fitness center
    ...
    # Announcements
    ann = create_announcement_to_business_unit(gus_employee_dub["id"], the_dub["id"], "New OC Fitness Tracker App", "We created a beautiful image...'", "2026-04-07", "17:25")
    # HighGround.png
    ...
    ann_2 = create_announcement_to_business_unit(gus_employee_dub["id"], the_dub["id"], "Lots of open shifts", "There are lots of open shifts available. Please pick one up!", "2026-04-06", "17:25")
